...
U 1 1 5D1C9929
P 9100 5650
F 0 "C508" H 9215 5696 50  0000 L CNN
...
U 1 1 5D2DABDB
P 4350 1150
F 0 "C504" H 4465 1196 50  0000 L CNN
...
U 1 1 5D2DADB9
P 3850 1150
F 0 "C503" H 3965 1196 50  0000 L CNN
...
U 1 1 5D2F1627
P 6050 1150
F 0 "C506" H 6165 1196 50  0000 L CNN
...
U 1 1 5D2F162D
P 5550 1150
F 0 "C505" H 5665 1196 50  0000 L CNN
...
U 1 1 5D3D2C36
P 6550 1150
F 0 "C507" H 6665 1196 50  0000 L CNN
...
U 1 1 5EBCD574
P 4100 1400
F 0 "#PWR0510" H 4100 1150 50  0001 C CNN
...
U 1 1 5EBD53EB
P 4400 4050
F 0 "#PWR0511" H 4400 3800 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CDMM1:GND_TRIG #PWR0514
U 1 1 5EBDBFF4
P 5000 4050
F 0 "#PWR0514" H 5000 3800 50  0001 C CNN
...
U 1 1 5EBDCCC1
P 7950 6100
F 0 "#PWR0526" H 7950 5850 50  0001 C CNN
...
U 1 1 5EBDD668
P 9100 6100
F 0 "#PWR0528" H 9100 5850 50  0001 C CNN
...
U 1 1 5EBDD8F0
P 9850 6100
F 0 "#PWR0529" H 9850 5850 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CDMM1:GND_TRIG #PWR0527
U 1 1 5EBDF6F2
P 8550 4950
F 0 "#PWR0527" H 8550 4700 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CDMM1:GND_TRIG #PWR0519
U 1 1 5EBE030C
P 5800 1400
F 0 "#PWR0519" H 5800 1150 50  0001 C CNN
...
U 1 1 5EBE0F56
P 6550 1400
F 0 "#PWR0523" H 6550 1150 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CDMM1:+5V_TRIG #PWR0518
U 1 1 5EBE2413
P 5800 900
F 0 "#PWR0518" H 5800 750 50  0001 C CNN
...
U 1 1 5EBE29CC
P 6550 900
F 0 "#PWR0522" H 6550 750 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CDMM1:+5V_TRIG #PWR0513
U 1 1 5EBE2D84
P 5000 2650
F 0 "#PWR0513" H 5000 2500 50  0001 C CNN
...
U 1 1 5EBE59AF
P 5250 3450
F 0 "#PWR0517" H 5250 3300 50  0001 C CNN
...
U 1 1 5EBE9033
P 7950 4200
F 0 "#PWR0525" H 7950 4050 50  0001 C CNN
...
U 1 1 5E72EC8D
P 5150 6750
F 0 "#PWR0515" H 5150 6600 50  0001 C CNN
...
U 1 1 5E7300C2
P 5150 7450
F 0 "#PWR0516" H 5150 7200 50  0001 C CNN
...
U 1 1 5DE91DF7
P 6050 7450
F 0 "#PWR0520" H 6050 7200 50  0001 C CNN
...
U 1 1 5DE9761E
P 6500 7450
F 0 "#PWR0521" H 6500 7300 50  0001 C CNN
...
U 1 1 5E381279
P 2850 1150
F 0 "C501" H 2965 1196 50  0000 L CNN
...
U 1 1 5E381C99
P 3350 1150
F 0 "C502" H 3465 1196 50  0000 L CNN
...
U 1 1 5E38746C
P 3350 1400
F 0 "#PWR0507" H 3350 1150 50  0001 C CNN
...
U 1 1 5E38D207
P 2850 1400
F 0 "#PWR0503" H 2850 1150 50  0001 C CNN
...
U 1 1 5E39EC61
P 3150 4050
F 0 "#PWR0505" H 3150 3800 50  0001 C CNN
...
U 1 1 5E9AD50E
P 6600 4500
F 0 "#PWR0524" H 6600 4250 50  0001 C CNN
...
U 1 1 5E4486F7
P 2950 2550
F 0 "#PWR0504" H 2950 2400 50  0001 C CNN
...
U 1 1 5E448EDA
P 2550 2500
F 0 "#PWR0501" H 2550 2350 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CDMM1:+3.3VF #PWR0502
U 1 1 5E449101
P 2850 900
F 0 "#PWR0502" H 2850 750 50  0001 C CNN
...
U 1 1 5E449C1E
P 3350 900
F 0 "#PWR0506" H 3350 750 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CDMM1:+3.3VF #PWR0509
U 1 1 5E449E8B
P 4100 900
F 0 "#PWR0509" H 4100 750 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CDMM1:+5VF #PWR0512
U 1 1 5E44BC82
P 4500 2650
F 0 "#PWR0512" H 4500 2500 50  0001 C CNN
