...
U 1 1 5DAA5490
P 7800 10700
F 0 "#PWR0220" H 7800 10450 50  0001 C CNN
...
U 1 1 5DB88AAB
P 650 9000
F 0 "#PWR0218" H 650 8750 50  0001 C CNN
...
U 1 1 5DB8FF79
P 650 8250
F 0 "R206" H 580 8204 50  0000 R CNN
...
NRST
Text HLabel 14600 6500 2    50   Output ~ 0
TRIG_EN
Text HLabel 14600 6400 2    50   Output ~ 0
TRIG_OUT
Text HLabel 14600 6300 2    50   Input ~ 0
TRIG_IN
Wire Wire Line
...
Wire Wire Line
	10700 9950 11050 9950
Wire Wire Line
	10700 10000 10700 9950
Wire Wire Line
	11050 10450 11050 10300
Wire Wire Line
	10700 10350 10700 10300
$Comp
L Device:R R208
U 1 1 5E0F3C03
P 11050 10150
F 0 "R208" H 11120 10196 50  0000 L CNN
...
U 1 1 5E0F3906
P 10700 10150
F 0 "R207" H 10770 10196 50  0000 L CNN
F 1 "4k7" H 10770 10105 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" V 10630 10150 50  0001 C CNN
...
U 1 1 5E096BB8
P 9200 10750
F 0 "#PWR0223" H 9200 10500 50  0001 C CNN
...
U 1 1 5E08CDE4
P 9650 10750
F 0 "#PWR0225" H 9650 10500 50  0001 C CNN
...
U 1 1 5E082698
P 9650 10450
F 0 "U203" H 10000 10800 50  0000 C CNN
...
U 1 1 5E648C3B
P 2750 6550
F 0 "R203" V 2543 6550 50  0000 C CNN
...
U 1 1 5E64A32E
P 2750 6950
F 0 "R204" V 2543 6950 50  0000 C CNN
...
U 1 1 5E64A698
P 2750 7350
F 0 "R205" V 2543 7350 50  0000 C CNN
...
U 1 1 5E422513
P 650 8100
F 0 "#PWR0217" H 650 7950 50  0001 C CNN
...
U 1 1 5E423A04
P 7800 10150
F 0 "#PWR0219" H 7800 10000 50  0001 C CNN
...
U 1 1 5E4244F9
P 9650 10150
F 0 "#PWR0224" H 9650 10000 50  0001 C CNN
...
U 1 1 5E4257CD
P 11050 9900
F 0 "#PWR0226" H 11050 9750 50  0001 C CNN
...
$Comp
L ETH1CDMM1:STM32H743ZI U202
U 1 1 5E468D70
P 8850 4950
F 0 "U202" H 8850 811 50  0000 C CNN
F 1 "STM32H743ZI" H 8850 720 50  0000 C CNN
...
DC_AMP1_MUX_A0
Text HLabel 3100 6000 0    50   Output ~ 0
DC_AMP1_MUX_A1
...
CXN_REL4
Text HLabel 14600 7500 2    50   Output ~ 0
CXN_REL3
Text HLabel 14600 7400 2    50   Output ~ 0
CXN_REL2
...
NoConn ~ 3150 5500
NoConn ~ 3150 5600
Text HLabel 3100 5100 0    50   Output ~ 0
DC_AMP_10MEG
Wire Wire Line
	3100 5100 3150 5100
NoConn ~ 3150 5700
